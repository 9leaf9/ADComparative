...
if __name__ == "__main__":
    ...
    for epoch in range(epochs):
        ...
        with torch.no_grad():
            ...
            # result.to_csv("/data1/qiaohezhe/MRI_Score/log/mci_nc/c3d_baseline.csv", mode='w',
            #               index=False, header=False)

            result.to_csv("/data1/qiaohezhe/MRI_Score/log/ad_nc/c3d_baseline_sgd001.csv", mode='w',
                          index=False, header=False)
            if early_stopping.early_stop:
                torch.save(model, "/data1/qiaohezhe/MRI_Score/log/ad_nc/model/c3d_baseline_sgd001/c3d_baseline.pth")
                print("Early stopping")
                break

            torch.save(model,
                       "/data1/qiaohezhe/MRI_Score/log/ad_nc/model/c3d_baseline_sgd001/c3d_baseline{}.pth".format(epoch))
    torch.save(model, "/data1/qiaohezhe/MRI_Score/log/ad_nc/model/c3d_baseline_sgd001/c3d_baseline.pth")

...
class AdniDataSet_train(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if math.fabs((float(score1) * 20 + 10) - (float(score2) * 20 + 10)) <= 4:
            label4 = 1
        elif (float(score1) * 20 + 10) - (float(score2) * 20 + 10) < -4:
            label4 = 0
        else:
            label4 = 2
        ...
        return img_array1, img_array2, label1, label2, label3, label4, float(score1) * 20 + 10, float(score2) * 20 + 10
...
class AdniDataSet_val(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if math.fabs((float(score1) * 26 + 4) - (float(score2) * 26 + 4))<= 4:
            label4 = 1
        elif (float(score1) * 26 + 4) - (float(score2) * 26 + 4) < -4:
            label4 = 0
        else:
            label4 = 2
        ...
        return img_array1, img_array2, label1, label2, label3, label4, float(score1)*26+4, float(score2)*26+4

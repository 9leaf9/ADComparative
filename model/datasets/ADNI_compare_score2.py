...
class AdniDataSet_train(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if math.fabs((float(score1) * 11 + 19) - (float(score2) * 11 + 19)) == 0:
            label4 = 1
        elif (float(score1) * 11 + 19) - (float(score2) * 11 + 19) < 0:
            label4 = 0
        else:
            label4 = 2
...
class AdniDataSet_val(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if math.fabs((float(score1) * 30) - (float(score2) * 30)) ==0:
            label4 = 1
        elif (float(score1)* 30) - (float(score2) * 30) < 0:
            label4 = 0
        else:
            label4 = 2
        ...
        return img_array1, img_array2, label1, label2, label3, label4, int(float(score1)*30), int(float(score2)*30)

...
class AdniDataSet_train(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if math.fabs((float(score1) * 11 + 19) - (float(score2) * 11 + 19)) <= 2:
            label4 = 1
        elif (float(score1) * 11 + 19) - (float(score2) * 11 + 19) < -2:
            label4 = 0
        else:
            label4 = 2
...
class AdniDataSet_val(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if math.fabs((float(score1) * 30) - (float(score2) * 30)) <= 2:
            label4 = 1
        elif (float(score1)* 30) - (float(score2) * 30) < -2:
            label4 = 0
        else:
            label4 = 2

...
import pandas as pd
from datasets.ADNI_joint2 import AdniDataSet_train
from datasets.ADNI_joint2 import AdniDataSet_val
...
if __name__ == "__main__":
    ...
    for epoch in range(epochs):
        ...
        for i, data in tqdm(enumerate(train_loader), total=len(train_loader)):
            ...
            logps1, logps2, embedding1, embedding2, logps_s, logps_g, logps_score1, logps_score2 = model.forward(
                inputs1,
                inputs2)
            print(logps_s)
            print(logps_score1)
            ...
            loss = 0.2 * loss_group + 0 * loss_compare + 0.8 * loss_contrastive + 0 * loss_score
            print("loss", loss)
        ...
        with torch.no_grad():
            ...
            for i, data in tqdm(enumerate(val_loader), total=len(val_loader)):
                ...
                inputs1, inputs2, labels1, labels2, labels3, labels4, score1, score2 = inputs1.to(device), inputs2.to(
                    ...
                    device)
                output1, output2, embedding1, embedding2, logps_s, logps_g, logps_score1, logps_score2 = model.forward(
                    inputs1,
                    inputs2)
            ...
            # result.to_csv("/data1/qiaohezhe/MRI_Score/log/mci_nc/model/joint/c3d_joint8200.csv", mode='w', index=False,
            #               header=False)
            # result.to_csv("/data1/qiaohezhe/MRI_Score/log/mci_nc_adni2/paper1/joint/c3d_joint8020.csv", mode='w', index=False,
            #               header=True)
            result.to_csv("/data1/qiaohezhe/MRI_Score/log/mci_nc_adni2/paper1/ablation/c3d_joint8020_8.csv", mode='w', index=False,
                          header=True)

            early_stopping(val_loss, model)

            if early_stopping.early_stop:
                # torch.save(model, "/data1/qiaohezhe/MRI_Score/log/mci_nc/model/joint/c3d_joint8020/c3d_score.pth")
                # torch.save(model, "/data1/qiaohezhe/MRI_Score/log/mci_nc_adni2/model1/joint/c3d_joint8020/c3d_score.pth")
                print("Early stopping")
                break
    #         torch.save(model,"/data1/qiaohezhe/MRI_Score/log/mci_nc/model/joint/c3d_joint8020/c3d_score{}.pth".format(epoch))
    # torch.save(model, "/data1/qiaohezhe/MRI_Score/log/mci_nc/model/joint/c3d_joint8020/c3d_score.pth")
    #         torch.save(model, "/data1/qiaohezhe/MRI_Score/log/mci_nc_adni2/model1/joint/c3d_joint8020/c3d_score{}.pth".format(epoch))
    # torch.save(model, "/data1/qiaohezhe/MRI_Score/log/mci_nc_adni2/model1/joint/c3d_joint8020/c3d_score.pth")

...
if __name__ == "__main__":
    ...
    for epoch in range(epochs):
        ...
        with torch.no_grad():
            ...
            result.to_csv("/data1/qiaohezhe/MRI_Score/log/mci_nc/mri_attention.csv", mode='w', index=False,
                          header=False)

            early_stopping(val_loss, model)

            if early_stopping.early_stop:
                torch.save(model, "/data1/qiaohezhe/MRI_Score/log/mci_nc/model/mri_attention/mri_attention.pth")
                print("Early stopping")
                break
            torch.save(model,
                       "/data1/qiaohezhe/MRI_Score/log/mci_nc/model/mri_attention/mri_attention{}.pth".format(epoch))
    torch.save(model, "/data1/qiaohezhe/MRI_Score/log/mci_nc/model/mri_attention/mri_attention.pth")

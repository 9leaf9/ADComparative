...
if __name__ == "__main__":
    ...
    for epoch in range(epochs):
        ...
        for i, data in tqdm(enumerate(train_loader), total=len(train_loader)):
            ...
            loss = 1 * loss_group + 0 * loss_compare + 0 * loss_score
            print("loss", loss)
        ...
        with torch.no_grad():
            ...
            result.to_csv("/data1/qiaohezhe/MRI_Score/log/ad_nc/paper/c3d_score1001.csv", mode='w', index=False,
                          header=False)

            early_stopping(val_loss, model)

            if early_stopping.early_stop:
                torch.save(model, "/data1/qiaohezhe/MRI_Score/log/ad_nc/paper/group/c3d_score1001/c3d_score.pth")
                print("Early stopping")
                break
            torch.save(model,
                       "/data1/qiaohezhe/MRI_Score/log/ad_nc/model/c3d_score1001/c3d_score{}.pth".format(epoch))
    torch.save(model, "/data1/qiaohezhe/MRI_Score/log/ad_nc/model/c3d_score1001/c3d_score.pth")

    ...
    for epoch in range(epochs):
        ...
        for i, data in tqdm(enumerate(train_loader), total=len(train_loader)):
            ...
            loss_contrastive = torch.mean((1 - labels3.float()) * torch.pow(euclidean_distance.float(), 2) +
                ...
                torch.clamp(3.0 - euclidean_distance.float(), min=0.0), 2))
            ...
            loss = 1 * loss_group + 0 * loss_compare + 0 * loss_contrastive + 0 * loss_score
            print("loss", loss)
        ...
        with torch.no_grad():
            ...
            result.to_csv("/data1/qiaohezhe/MRI_Score/log/mci_nc_adni2/paper/joint/c3d_joint10001.csv", mode='w', index=False,
                          header=False)
            ...
            if early_stopping.early_stop:
                ...
                torch.save(model, "/data1/qiaohezhe/MRI_Score/log/mci_nc/model/joint/c3d_joint10001/c3d_score.pth")
                print("Early stopping")
                break
    #         torch.save(model,"/data1/qiaohezhe/MRI_Score/log/mci_nc/model/joint/c3d_joint8020/c3d_score{}.pth".format(epoch))
    # torch.save(model, "/data1/qiaohezhe/MRI_Score/log/mci_nc/model/joint/c3d_joint8020/c3d_score.pth")
            torch.save(model, "/data1/qiaohezhe/MRI_Score/log/mci_nc_adni2/model/joint/c3d_joint10001/c3d_score{}.pth".format(epoch))
    torch.save(model, "/data1/qiaohezhe/MRI_Score/log/mci_nc_adni2/model/joint/c3d_joint10001/c3d_score.pth")

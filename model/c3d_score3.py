...
if __name__ == "__main__":
    ...
    for epoch in range(epochs):
        ...
        for i, data in tqdm(enumerate(train_loader), total=len(train_loader)):
            ...
            # 6，2，2#
            # 5，1，4#
            loss = 0.6 * loss_group + 0.4 * loss_compare + 0 * loss_score
            print("loss", loss)
            ...
            running_consine_distance += consine_distance.item()
        ...
        train_consine_distance = running_consine_distance / len(train_loader)
        ...
        with torch.no_grad():
            ...
            val_consine_distance = running_consine_distance / len(val_loader)
            ...
            # result.to_csv("/data1/qiaohezhe/MRI_Score/log/ad_nc_adni2/paper1/group/c3d_score820.csv", mode='w', index=False,
            #               header=True)
            # result.to_csv("/data1/qiaohezhe/MRI_Score/log/ad_nc_all/paper1/group/c3d_score820_score0.csv", mode='w',
            #               index=False,
            #               header=True)

            result.to_csv("/data1/qiaohezhe/MRI_Score/log/ad_nc_adni2/paper1/ablation/c3d_score820_score2_4.csv", mode='w', index=False,
                          header=True)
            # result.to_csv("/data1/qiaohezhe/MRI_Score/log/ad_nc_all/paper1/ablation/c3d_score820_score4_8.csv", mode='w', index=False,
            #               header=True)

            early_stopping(val_loss, model)

            if early_stopping.early_stop:
                # torch.save(model, "/data1/qiaohezhe/MRI_Score/log/ad_nc_adni2/model1/group/c3d_score820/c3d_score.pth")
                # torch.save(model, "/data1/qiaohezhe/MRI_Score/log/ad_nc_all/model1/group/c3d_score820_score0/c3d_score.pth")
                print("Early stopping")
                break
    #         torch.save(model,
    #                    "/data1/qiaohezhe/MRI_Score/log/ad_nc_all/model1/group/c3d_score820_score0/c3d_score{}.pth".format(epoch))
    # torch.save(model, "/data1/qiaohezhe/MRI_Score/log/ad_nc_all/model1/group/c3d_score820_score0/c3d_score.pth")

    #         torch.save(model,
    #                    "/data1/qiaohezhe/MRI_Score/log/ad_nc_adni2/model1/group/c3d_score820/c3d_score{}.pth".format(epoch))
    # torch.save(model, "/data1/qiaohezhe/MRI_Score/log/ad_nc_adni2/model1/group/c3d_score820/c3d_score.pth")

...
if __name__ == "__main__":
    ...
    model_path = "/data1/qiaohezhe/MRI_Score/log/mci_nc_adni2/model1/group/c3d_score820_score0/c3d_score23.pth"
    ...
    # data_csv.to_csv("/data1/qiaohezhe/MRI_Score/log/ad_nc_adni2/infer/group/c3d_score100.csv", index=False)
    # data_csv.to_csv("/data1/qiaohezhe/MRI_Score/log/mci_nc_adni2/infer/group/c3d_score100.csv", index=False)

    # data_csv.to_csv("/data1/qiaohezhe/MRI_Score/log/ad_nc_all/infer/group/c3d_score820.csv", index=False)
    # data_csv.to_csv("/data1/qiaohezhe/MRI_Score/log/ad_nc_adni2/infer/group/c3d_score820.csv", index=False)
    data_csv.to_csv("/data1/qiaohezhe/MRI_Score/log/mci_nc_adni2/infer/group/c3d_score8201.csv", index=False)

...
if __name__ == "__main__":
    ...
    # train_data_path1 = '/data1/qiaohezhe/AD2/adni2_ad_nc_val_label.csv'
    # train_data_path2 = '/data1/qiaohezhe/AD2/adni2_ad_nc_val_label_shuffle.csv'
    # train_img_path = '/data1/qiaohezhe/AD2/ad_nc_regsiter/'

    train_data_path1 = '/data1/qiaohezhe/AD2/adni2_mci_nc_val_label.csv'
    train_data_path2 ='/data1/qiaohezhe/AD2/adni2_mci_nc_val_label_shuffle.csv'
    train_img_path = '/data1/qiaohezhe/AD2/mci_nc_regsiter/'

    model_path = "/data1/qiaohezhe/MRI_Score/log/mci_nc_adni2/model1/joint/c3d_joint8020/c3d_score63.pth"
    ...
    for mri1, mri2, label1, label2 in zip(mri_list1, mri_list2, label_list1, label_list2):
        ...
        with torch.no_grad():
            ...
            logps1, logps2, embedding1, embedding2, logps_s, logs_g, logps_score1, logps_score2 = model(inputs1,
                                                                                                        inputs2)
    ...
    # data_csv.to_csv("/data1/qiaohezhe/MRI_Score/log/ad_nc_all/infer/joint/c3d_joint8020.csv", index=False)
    # data_csv.to_csv("/data1/qiaohezhe/MRI_Score/log/ad_nc_adni2/infer/joint/c3d_joint8020.csv", index=False)
    data_csv.to_csv("/data1/qiaohezhe/MRI_Score/log/mci_nc_adni2/infer/joint/c3d_joint8020.csv", index=False)

...
sys.path.append('/home/qiaohezhe/code/MRI_Score/util')
import os
# print(os.getcwd())
...
filePath = '/data1/qiaohezhe/AD2/mci_nc/'
savePath = '/data1/qiaohezhe/AD2/mci_nc_regsiter/'
file_lsit = os.listdir(filePath)
for index, file in tqdm(enumerate(file_lsit), total=len(file_lsit)):
        img = nib.load(filePath + file)
        img = img.get_data()
